...
ScrollReveal().reveal(".home-titulo-primario", { delay: 350 });
ScrollReveal().reveal(".home-titulo", { delay: 450 });
ScrollReveal().reveal(".home-titulo-secundario", { delay: 550 });
...
ScrollReveal().reveal(".home-class", {delay: 350});
